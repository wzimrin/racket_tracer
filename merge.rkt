  ...
  (cond
    ...
    [(and (cons? list1)
     ...
     (if (< (first list1) (first list2))
         (cons (first list2) (merge-A (rest list1) (rest list2)))
         (cons (first list1) (merge-A list1 (rest list2))))]))

(: generate-input (Integer -> (list-of (list-of Integer))))
...
(: build-lists (Integer Integer  -> (list-of (list-of Integer))))
...
(: random-list (Integer -> (list-of Integer)))
...
(: ins-at (Integer Integer (list-of Integer) -> (list-of Integer)))
