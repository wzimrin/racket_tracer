var theTrace = {name: "top-level",
            ...
            resultShort: "1\n",
            children: []},{name: "remove-min",
            formals: ["(make-heap (list 1 2 3))\n"],
            formalsShort: ["(make-heap (list 1 2 3))\n"],
            actuals: ["'#(struct:bhnode\n   1\n   #(struct:bhnode 3 () ())\n   #(struct:bhnode 2 () ()))\n"],
            actualsShort: ["'#(struct:bhnode\n   1\n   #(struct:bhnode 3 () ())\n   #(struct:bhnode 2 () ()))\n"],
            result: "'#(struct:bhnode\n   2\n   #(struct:bhnode 3 () ())\n   ())\n",
            resultShort: "'#(struct:bhnode\n   2\n   #(struct:bhnode 3 () ())\n   ())\n",
            ...
            formals: ["l\n"],
            formalsShort: ["l\n"],
            actuals: ["'#(struct:bhnode 3 () ())\n"],
            actualsShort: ["'#(struct:bhnode 3 () ())\n"],
            result: "3\n",
            resultShort: "3\n",
            children: []}]},{name: "remove-left-most",
            formals: ["h\n"],
            ...
            formals: ["y\n"],
            formalsShort: ["y\n"],
            actuals: ["'#(struct:bhnode 2 () ())\n"],
            actualsShort: ["'#(struct:bhnode 2 () ())\n"],
            result: "2\n",
            resultShort: "2\n",
            children: []},{name: "get-min",
            formals: ["l\n"],
            ...
            actuals: ["2\n","'()\n"],
            actualsShort: ["2\n","'()\n"],
            result: "'#(struct:bhnode 2 () ())\n",
            resultShort: "'#(struct:bhnode 2 () ())\n",
            children: []}]},{name: "insert",
            formals: ["x\n","h\n"],
            formalsShort: ["x\n","h\n"],
            actuals: ["3\n","'#(struct:bhnode\n   1\n   #(struct:bhnode 2 () ())\n   ())\n"],
